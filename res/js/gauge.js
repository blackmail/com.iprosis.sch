(function() {
	//var pointerNo = 0; // Eitan Rabinovich, Aug 18, 2014 - 9:31:59 AM

    var AnimatedText, AnimatedTextFactory, Bar, BaseDonut, BaseZGauge, Donut, ZGauge, ZGaugePointer, TextRenderer, ValueUpdater, addCommas, cutHex, formatNumber, mergeObjects, secondsToString, updateObjectValues, _ref, _ref1, __hasProp = {}.hasOwnProperty,
    ...
    updateObjectValues = function(obj1, obj2) {
        ...
        for (key in obj2) {
            ...
            //if (key != "color" && pointerNo < 2){ // Eitan Rabinovich, Aug 18, 2014 - 9:28:03 AM            
	            val = obj2[key];
	            obj1[key] = val;
            //} else { // Eitan Rabinovich, Aug 18, 2014 - 9:43:44 AM
            	//pointerNo++; // Eitan Rabinovich, Aug 18, 2014 - 9:36:56 AM
            //}// Eitan Rabinovich, Aug 18, 2014 - 9:28:13 AM
    ...
    BaseZGauge = (function(_super) {
        __extends(BaseZGauge, _super);

        function BaseZGauge() {
            _ref = BaseZGauge.__super__.constructor.apply(this, arguments);
            return _ref;
        }
        BaseZGauge.prototype.displayScale = 1;
        BaseZGauge.prototype.setTextField = function(textField) {
            return this.textField = textField instanceof TextRenderer ? textField : new TextRenderer(textField);
        };
        BaseZGauge.prototype.setMinValue = function(minValue, updateStartValue) {
        ...
        BaseZGauge.prototype.setOptions = function(options) {
            if (options == null) {
                options = null;
            }
        ...
        BaseZGauge.prototype.configDisplayScale = function() {
    ...
    ZGaugePointer = (function(_super) {
        __extends(ZGaugePointer, _super);
        ZGaugePointer.prototype.displayedValue = 0;
        ZGaugePointer.prototype.value = 0;
        ZGaugePointer.prototype.options = {
            strokeWidth: 0.035,
            length: 0.1,
            color: "#000000"
        };

        function ZGaugePointer(gauge) {
            this.gauge = gauge;
            this.ctx = this.gauge.ctx;
            this.canvas = this.gauge.canvas;
            ZGaugePointer.__super__.constructor.call(this, false, false);
            this.setOptions();
        }
        ZGaugePointer.prototype.setOptions = function(options) {
            if (options == null) {
                options = null;
            }
        ...
        ZGaugePointer.prototype.render = function() {
    ...
    ZGauge = (function(_super) {
        __extends(ZGauge, _super);
        ZGauge.prototype.elem = null;
        ZGauge.prototype.value = [20];
        ZGauge.prototype.maxValue = 80;
        ZGauge.prototype.minValue = 0;
        ZGauge.prototype.displayedAngle = 0;
        ZGauge.prototype.displayedValue = 0;
        ZGauge.prototype.lineWidth = 40;
        ZGauge.prototype.paddingBottom = 0.1;
        ZGauge.prototype.percentColors = null;
        ZGauge.prototype.options = {
            colorStart: "#6fadcf",
            colorStop: void 0,
            gradientType: 0,
            strokeColor: "#e0e0e0",
        ...
        function ZGauge(canvas) {
            this.canvas = canvas;
            ZGauge.__super__.constructor.call(this);
            this.percentColors = null;
            if (typeof G_vmlCanvasManager !== 'undefined') {
                this.canvas = window.G_vmlCanvasManager.initElement(this.canvas);
            }
            this.ctx = this.canvas.getContext('2d');
            this.gp = [new ZGaugePointer(this)];
            this.setOptions();
            this.render();
        }
        ZGauge.prototype.setOptions = function(options) {
            var gauge, _i, _len, _ref1;
            if (options == null) {
                options = null;
            }
            ZGauge.__super__.setOptions.call(this, options);
        ...
        ZGauge.prototype.configPercentColors = function() {
        ...
        ZGauge.prototype.set = function(value) {
            ...
            if (value.length > this.gp.length) {
                for (i = _i = 0, _ref1 = value.length - this.gp.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
                    this.gp.push(new ZGaugePointer(this));
                }
            }
            i = 0;
            max_hit = false;
        ...
        ZGauge.prototype.getAngle = function(value) {
            return (1 + this.options.angle) * Math.PI + ((value - this.minValue) / (this.maxValue - this.minValue)) * (1 - this.options.angle * 2) * Math.PI;
        };
        ZGauge.prototype.getColorForPercentage = function(pct, grad) {
        ...
        ZGauge.prototype.getColorForValue = function(val, grad) {
            var pct;
            pct = (val - this.minValue) / (this.maxValue - this.minValue);
            return this.getColorForPercentage(pct, grad);
        };
        ZGauge.prototype.render = function() {
